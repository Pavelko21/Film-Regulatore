                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  children: [
                                                    CopyLink(
                                                      tmdbId: "tv/$tvId/season/" + info.seasonNumber.toString(),
                                                      title: info.name,
                                                      id: tvId,
                                                      type:
                                    ...
                                    child: DelayedDisplay(
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CachedNetworkImage(imageUrl: info.posterPath),
                                        ),
                                      ),
                                    )),
                                Expanded(
                                        ...
                                        DelayedDisplay(
                                          ...
                                          child: RichText(
                                            text: TextSpan(
                                              ...
                                              children: [
                                                TextSpan(text: info.customDate + " | ",),
                                                TextSpan(text: info.episodes.length.toString() + " Episodes",),
                                              ],
                                            ),
                                          ),
                                        ),
                                          ...
                                          Row(
                                            children: [
                                              IconTheme(
                                                ...
                                                child: StarDisplay(
                                                  value: info.episodes[i].voteAverage,
                                                ),
                                              ),
                                              Text(
