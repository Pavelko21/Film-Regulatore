...
import 'package:movieinfo/screens/favorite_screen/favorite_model.dart';
...
class _FavoriteScreenState extends State<FavoriteScreen> {
  ...
  void buildFavoriteModel() {
    List<dynamic> list = Hive.box('Favorites').values.toList();

    for (var i = 0; i < list.length; i++) {
      models.add(FavoriteModel.fromMap(list[i]));
    }
  }
